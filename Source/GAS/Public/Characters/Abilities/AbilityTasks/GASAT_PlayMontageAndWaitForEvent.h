...
#include "GASAT_PlayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class GAS_API UGASAT_PlayMontageAndWaitForEventT_WaitReceiveDamage : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	// Constructor and overrides
	UGASAT_PlayMontageAndWaitForEventT_WaitReceiveDamage(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static UGASAT_PlayMontageAndWaitForEventT_WaitReceiveDamage* PlayMontageAndWaitForEvent(
