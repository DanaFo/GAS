 ...
 */
UCLASS()
class GAS_API UGASAT_WaitReceiveDamage : public UAbilityTask
{
	...
	static UGASAT_WaitReceiveDamage* WaitReceiveDamage(UGameplayAbility* OwningAbility, bool TriggerOnce);
